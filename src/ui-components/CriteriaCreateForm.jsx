...
import { createCriteria } from "../graphql/mutations";
const client = generateClient();
export default function CriteriaCreateForm(props) {
  const {
    clearOnSuccess = true,
    onSuccess,
    onError,
  ...
  const resetStateValues = () => {
    ...
    setF(initialValues.F);
    setG(initialValues.G);
    setH(initialValues.H);
    setI(initialValues.I);
    setJ(initialValues.J);
    setK(initialValues.K);
    setL(initialValues.L);
    setM(initialValues.M);
    setN(initialValues.N);
    setO(initialValues.O);
    setP(initialValues.P);
    setQ(initialValues.Q);
    setR(initialValues.R);
    setS(initialValues.S);
    setT(initialValues.T);
    setU(initialValues.U);
    setV(initialValues.V);
    setW(initialValues.W);
    setX(initialValues.X);
    setY(initialValues.Y);
    setZ(initialValues.Z);
    setErrors({});
  };
  const validations = {
    A: [],
  ...
  return (
    <Grid
      ...
      onSubmit={async (event) => {
        ...
        try {
          ...
          await client.graphql({
            query: createCriteria.replaceAll("__typename", ""),
            variables: {
              input: {
                ...modelFields,
              },
      ...
      {...getOverrideProps(overrides, "CriteriaCreateForm")}
      {...rest}
    >
      <TextField
        label="A"
