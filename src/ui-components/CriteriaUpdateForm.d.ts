...
export declare type CriteriaUpdateFormInputValues = {
    A?: string;
    B?: string;
    C?: string;
    D?: string;
...
export declare type CriteriaUpdateFormValidationValues = {
...
export declare type CriteriaUpdateFormOverridesProps = {
    CriteriaUpdateFormGrid?: PrimitiveOverrideProps<GridProps>;
...
export declare type CriteriaUpdateFormProps = React.PropsWithChildren<{
    overrides?: CriteriaUpdateFormOverridesProps | undefined | null;
} & {
    id?: string;
    criteria?: Criteria;
    onSubmit?: (fields: CriteriaUpdateFormInputValues) => CriteriaUpdateFormInputValues;
    onSuccess?: (fields: CriteriaUpdateFormInputValues) => void;
    onError?: (fields: CriteriaUpdateFormInputValues, errorMessage: string) => void;
    onChange?: (fields: CriteriaUpdateFormInputValues) => CriteriaUpdateFormInputValues;
    onValidate?: CriteriaUpdateFormValidationValues;
} & React.CSSProperties>;
export default function CriteriaUpdateForm(props: CriteriaUpdateFormProps): React.ReactElement;
